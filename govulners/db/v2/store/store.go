...
import (
	...
	"github.com/nextlinux/govulners/govulners/db/internal/gormadapter"
	v2 "github.com/nextlinux/govulners/govulners/db/v2"
	"github.com/nextlinux/govulners/govulners/db/v2/store/model"
	"github.com/nextlinux/govulners/internal"
	_ "github.com/nextlinux/sqlite" // provide the sqlite dialect to gorm via import
)
