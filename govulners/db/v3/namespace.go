...
import (
	...
	packageurl "github.com/nextlinux/packageurl-go"
...
func NamespaceForDistro(d *distro.Distro) string {
	...
	if len(versionSegments) > 0 {
		switch d.Type {
		// derived from https://github.com/nextlinux/nextlinux-engine/blob/5bbbe6b9744f2fb806198ae5d6f0cfe3b367fd9d/nextlinux_engine/services/policy_engine/__init__.py#L149-L159
