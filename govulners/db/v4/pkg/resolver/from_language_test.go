...
import (
	...
	"github.com/nextlinux/govulners/govulners/db/v4/pkg/resolver/java"
	"github.com/nextlinux/govulners/govulners/db/v4/pkg/resolver/python"
	"github.com/nextlinux/govulners/govulners/db/v4/pkg/resolver/stock"
