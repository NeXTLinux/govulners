...
func TestSecDBOnlyMatch(t *testing.T) {
	...
	secDbVuln := govulnersDB.Vulnerability{
	...
	store := mockStore{
		backend: map[string]map[string][]govulnersDB.Vulnerability{
			"secdb:distro:alpine:3.12": {
				"libvncserver": []govulnersDB.Vulnerability{secDbVuln},
			},
		},
	}
...
func TestBothSecdbAndNvdMatches(t *testing.T) {
	...
	nvdVuln := govulnersDB.Vulnerability{
		ID:                "CVE-2020-1",
		VersionConstraint: "<= 0.9.11",
	...
	store := mockStore{
		backend: map[string]map[string][]govulnersDB.Vulnerability{
			"nvd:cpe": {
				"libvncserver": []govulnersDB.Vulnerability{nvdVuln},
			},
			"secdb:distro:alpine:3.12": {
				"libvncserver": []govulnersDB.Vulnerability{secDbVuln},
			},
...
func TestBothSecdbAndNvdMatches_DifferentPackageName(t *testing.T) {
	...
	store := mockStore{
		backend: map[string]map[string][]govulnersDB.Vulnerability{
			"nvd:cpe": {
				"libvncumbrellaproject": []govulnersDB.Vulnerability{nvdVuln},
			},
			"secdb:distro:alpine:3.12": {
				"libvncserver": []govulnersDB.Vulnerability{secDbVuln},
			},
...
func TestNvdMatchesProperVersionFiltering(t *testing.T) {
	nvdVulnMatch := govulnersDB.Vulnerability{
		ID:                "CVE-2020-1",
		VersionConstraint: "<= 0.9.11",
		VersionFormat:     "unknown",
		CPEs:              []string{`cpe:2.3:a:lib_vnc_project-\(server\):libvncserver:*:*:*:*:*:*:*:*`},
	...
	nvdVulnNoMatch := govulnersDB.Vulnerability{
		ID:                "CVE-2020-2",
		VersionConstraint: "< 0.9.11",
		VersionFormat:     "unknown",
		CPEs:              []string{`cpe:2.3:a:lib_vnc_project-\(server\):libvncserver:*:*:*:*:*:*:*:*`},
	...
	store := mockStore{
		backend: map[string]map[string][]govulnersDB.Vulnerability{
			"nvd:cpe": {
				"libvncserver": []govulnersDB.Vulnerability{nvdVulnMatch, nvdVulnNoMatch},
			},
		},
	}
...
func TestDistroMatchBySourceIndirection(t *testing.T) {
	...
	store := mockStore{
		backend: map[string]map[string][]govulnersDB.Vulnerability{
			"secdb:distro:alpine:3.12": {
				"musl": []govulnersDB.Vulnerability{secDbVuln},
			},
		},
	}
...
func TestNVDMatchBySourceIndirection(t *testing.T) {
	...
	store := mockStore{
		backend: map[string]map[string][]govulnersDB.Vulnerability{
			"nvd:cpe": {
				"musl": []govulnersDB.Vulnerability{nvdVuln},
			},
		},
	}
